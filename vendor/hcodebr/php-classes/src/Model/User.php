...
const SUCCESS = "userSuccess";
	...
	// verificar se o usuario que faz compras esta logado ou não
	public static function checkLogin($inadmin = true){
		if (!isset($_SESSION[User::SESSION])
			...
			// so acontece se tentar acessar uma rota de admin
	...
	public static function getErrorRegister(){
		 ...
		 User::clearErrorRergister();

		 return $msg;
	}

	public static function clearErrorRergister(){
	...
	$results = $sql->select("SELECT * FROM tb_orders a INNER JOIN tb_ordersstatus b USING(idstatus) INNER JOIN tb_carts c USING(idcart) INNER JOIN tb_users d ON d.iduser = a.iduser INNER JOIN tb_addresses e USING(idaddress) INNER JOIN tb_persons f ON f.idperson = d.idperson WHERE a.iduser = :iduser", array(
		":iduser"=>$this->getiduser()
	));
