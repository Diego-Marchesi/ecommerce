...
// criando criando rota pagseguro 
...
$dadosboleto["endereco1"] =utf8_decode($order->getdesaddress())." ".$order->getdescomplement()." ".$order->getdesdistrict()." ".$order->getdescity();
$dadosboleto["endereco2"] = $order->getdesstate()." ".$order->getdescountry()." - CEP:".$order->getdeszipcode();
